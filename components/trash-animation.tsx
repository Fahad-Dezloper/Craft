          ...
          {imagesToRemove.length > 0 && !readyToRemove ? (
            ...
            >
              <div className="flex w-full justify-between gap-1">
                <button className="flex w-12 flex-col items-center gap-[1px] rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 text-[10px] font-medium text-[#8D8D86]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  ...
                  className="flex w-12 flex-col items-center gap-[1px] rounded-lg bg-[#F9F9F8] pt-[6px] pb-1 text-[10px] font-medium text-[#8D8D86] hover:bg-[#FFF7F7] hover:text-[#E5484D]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
