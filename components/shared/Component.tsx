...
type ViewSetterProps = {
  setView: (view: string) => void;
};

export function Phrase({ setView }: ViewSetterProps) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function Key({ setView }: ViewSetterProps) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function RemoveWallet({ setView }: ViewSetterProps) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function DefaultView({ setView }: ViewSetterProps) {
  return (
    <>
