          ...
          <div className="h-[35vh] w-[23vw] rounded-[42px] p-8 border-2 border-white bg-[#F9FAFC] shadow-[80px_-80px_80px_-92px_45px_rgba(0,0,0,0.8)]">
            <div className="w-full h-full flex flex-col ">
                <div className="w-full relative h-full">
                    ...
                    <div className="w-[10vw] rounded-2xl absolute z-20 right-12 top-12 bg-green-400 h-[9vh]"></div>
                    <div className="w-[10vw] rounded-2xl absolute z-10 right-24 top-24 bg-purple-400 h-[9vh]"></div>
                </div>
                <div className="w-full h-fit flex items-center gap-2 text-[#1D2F3A] font-medium leading-tight ">
                    <span className="text-neutral-500">Learn more from you data <br /> and make better decisions</span>
                    <span className="p-2 bg-[#E0EDED] rounded-xl h-fit">
...
const CurvedHero = () => {
    return (
        <div className="relative w-full h-full">
            <div className="size-20 absolute bottom-18 left-16 z-30 rounded-full bg-green-400" />
            <div className="size-20 absolute bottom-18 right-16 z-30 rounded-full bg-green-400 " />
            <div className="size-16 absolute bottom-34 left-34 z-20 rounded-full bg-red-400 " />
            <div className="size-16 absolute bottom-34 right-34 z-20 rounded-full bg-red-400 " />
            <div className="flex absolute items-center bottom-6 left-36 z-50 px-4 py-2 rounded-4xl bg-[#425565]">
                <AppleIcon />
        ...
        <div className="  w-full h-full" style={{ clipPath: "circle(92% at 50% 148%)" }}>
        </div>
        </div>
        <div className="inset-0 absolute z-20 overflow-hidden">
        <div className=" bg-white opacity-30  w-full h-full" style={{ clipPath: "circle(82% at 50% 148%)" }}>
        </div>
        </div>
        <div className="inset-0 absolute z-30 ">
        <div className=" bg-white opacity-30 w-full h-full" style={{ clipPath: "circle(72% at 50% 154%)" }}></div>
        </div>
        <div className="inset-0 absolute z-40">
        <div className=" bg-white opacity-30 w-full h-full" style={{ clipPath: "circle(62% at 50% 160%)" }}></div>
        </div>
      </div>
    )
  }
