export function RecoveryPhraseIcon() {
    ...
    export function QuestionMarkIcon({ className, width = "20", height = "20" }) {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" className={`lucide lucide-circle-question-mark-icon lucide-circle-question-mark ${className || ''}`} width={width} height={height} viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
    );
    }

    export function CloseIcon2({className, width = "20", height = "20"}) {
    return (
      <svg
        width={width}
        height={height}
    ...
    export function ChevronLeftt({className, width = "20", height = "20"}) {
      return (
